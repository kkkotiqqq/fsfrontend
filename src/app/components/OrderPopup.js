...
export default function OrderPopup(product) {
  return (
    <Popup
      trigger={
        <button className="button bg-[#202526] border border-[#FFFBC6] rounded-[10px] h-[50px] w-full mb-4 lg:mb-7 flex items-center justify-center shadow-lg shadow-black/30 text-white mx-auto font-normal gap-1 uppercase mt-7 lg:mt-14">
          {" "}
          Заказать{" "}
        </button>
      }
